...
final class ResearchBossProfile implements BossProfile {
    static final ResearchBossProfile ZULRAH=new ResearchBossProfile("zulrah","Zulrah",new int[]{2042,2043,2044},new int[]{9007,9008});
    static final ResearchBossProfile DUKE=new ResearchBossProfile("duke","Duke Sucellus",new int[]{12167,12191,12192},new int[]{12132});
    static final ResearchBossProfile PHOSANI=new ResearchBossProfile("phosanis_nightmare","Phosani's Nightmare",new int[]{377,9417,9418,9420,9421,9422,9424,11153,11154,11155},new int[]{15515});
    private final String id,name;
    private final int[] npcs,regions;
    private ResearchBossProfile(String id,String name,int[] npcs,int[] regions){this.id=id;this.name=name;this.npcs=npcs;this.regions=regions;}
    ...
    public boolean containsEncounterTile(WorldPoint p,boolean instanced){
        if(!instanced||p==null||p.getPlane()!=0)return false;
